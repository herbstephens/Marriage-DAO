...
export const CONTRACT_ADDRESSES = {
  HUMAN_BOND: '0xbDbFC4Bb5a741E2dF6e23a9AfBfC6e6463f4C9a3' as const,
  VOW_NFT: '0x6cd05972729de3aA4f44aF0819FE66BBa26FBd6F' as const,
  MILESTONE_NFT: '0x2047c6b8fb809A034A79BCE188040711ca6882cE' as const,
  TIME_TOKEN: '0xcBD75da9D507879A09dF611366f27d71969aC94c' as const,
} as const
...
export const VOW_NFT_ABI = [
  ...
  {"type":"function","name":"getTokensByMarriage","inputs":[{"name":"marriageId","type":"bytes32","internalType":"bytes32"}],"outputs":[{"name":"","type":"uint256[2]","internalType":"uint256[2]"}],"stateMutability":"view"},
  {"type":"function","name":"humanBondContract","inputs":[],"outputs":[{"name":"","type":"address","internalType":"address"}],"stateMutability":"view"},
  {"type":"function","name":"imageCID","inputs":[],"outputs":[{"name":"","type":"string","internalType":"string"}],"stateMutability":"view"},
  ...
  {"type":"function","name":"marriageToToken","inputs":[{"name":"","type":"bytes32","internalType":"bytes32"},{"name":"","type":"uint256","internalType":"uint256"}],"outputs":[{"name":"","type":"uint256","internalType":"uint256"}],"stateMutability":"view"},
  {"type":"function","name":"mintVowNFT","inputs":[{"name":"to","type":"address","internalType":"address"},{"name":"_partnerA","type":"address","internalType":"address"},{"name":"_partnerB","type":"address","internalType":"address"},{"name":"_bondStart","type":"uint256","internalType":"uint256"},{"name":"_marriageId","type":"bytes32","internalType":"bytes32"}],"outputs":[{"name":"","type":"uint256","internalType":"uint256"}],"stateMutability":"nonpayable"},
  ...
  {"type":"function","name":"setImageCID","inputs":[{"name":"newCid","type":"string","internalType":"string"}],"outputs":[],"stateMutability":"nonpayable"},
  ...
  {"type":"event","name":"VowMinted","inputs":[{"name":"marriageId","type":"bytes32","indexed":true,"internalType":"bytes32"},{"name":"tokenId","type":"uint256","indexed":true,"internalType":"uint256"},{"name":"to","type":"address","indexed":true,"internalType":"address"}],"anonymous":false},
  ...
  {"type":"error","name":"VowNFT__TransfersDisabled","inputs":[]},
  {"type":"error","name":"VowNFT__UnauthorizedMinter","inputs":[]}
] as const
